  ...
  render() {
    return (
      ...
      <Card style={{backgroundColor: "#606060", borderRadius:'20px'}} className="workproject">
       ...
       I've got experience with coding layouts in React and how to code in a modular way.</p>
       </Card>
       </Grid>
       <Grid item xs={12} sm={4}>
       <Card style={{backgroundColor: "#606060", borderRadius:'20px'}} className="workproject">
       ...
       I've got experience with creating a layout in Ionic and building up the connection between the front-end and back-end.</p>
       </Card>
       </Grid>
       <Grid item xs={12} sm={4}>
       <Card style={{backgroundColor: "#606060", borderRadius:'20px'}} className="workproject">
